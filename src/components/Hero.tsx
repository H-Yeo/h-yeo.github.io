        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-6xl lg:text-8xl font-extrabold tracking-tighter leading-[0.95] text-slate-900 dark:text-white mb-4 font-display">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-white/20 dark:to-white/5 border-slate-900 drop-shadow-sm" style={{ WebkitTextStroke: '1px rgba(15, 23, 42, 0.1)' }}>
            ...
            <div className="flex flex-wrap gap-4 mb-16">
              <a href="#contact" className="px-8 py-4 bg-blue-600 dark:bg-blue-500 text-white rounded-xl font-mono text-sm font-bold hover:bg-blue-700 dark:hover:bg-blue-400 transition-all flex items-center gap-2 group shadow-lg shadow-blue-500/20">
                Discuss a contract <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="#experience" className="px-8 py-4 bg-white dark:bg-slate-900/50 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 rounded-xl font-mono text-sm font-bold hover:border-slate-400 dark:hover:border-slate-600 transition-all">
                View experience
              </a>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {["C# / .NET", "React", "TypeScript", "Microservices", "AWS"].map(tech => (
                <span key={tech} className="px-3 py-1 bg-blue-100/50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/20 rounded-full font-mono text-[10px] font-bold">
                  {tech}
                </span>
              ))}
            </div>
          ...
          >
            ...
            <div className="col-span-2 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden group hover:-translate-y-1 transition-transform">
              ...
              <p className="font-mono text-[10px] uppercase font-bold text-slate-400 mb-2">Current engagement</p>
              <p className="text-lg font-bold text-slate-900 dark:text-white leading-tight mb-2">
                Government of Canada<br/>
                <span className="text-sm font-normal text-slate-500">Dept. of National Defence</span>
              </p>
            ...
            <div className="col-span-2 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none relative overflow-hidden group hover:-translate-y-1 transition-transform">
              ...
              <p className="text-lg font-bold text-slate-900 dark:text-white leading-tight mb-1">{RESUME_DATA.education.degree}</p>
